...
def main() -> None:
    ...
    for arg in sys.argv:
        if arg == "-nn":
            print(
                "Warning: '-nn' argument has been deprecated in favour of '-N'",
                file=sys.stderr,
            )
            argv.append("-N")
        elif arg == "-nm":
            print(
                "Warning: '-nm' argument has been deprecated in favour of '-M'",
                file=sys.stderr,
            )
            argv.append("-M")
        else:
    ...
    rootdir = (Path(args.cirrus_versions_path) / args.cirrus_version).resolve()
